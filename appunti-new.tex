...
\hspace*{\fill} $\left[G = 3\ ;\ \text{vantaggiosa}\right]$
\end{esercizio}
...
Per un corpo \textbf{omogeneo e regolare}, il baricentro coincide con il centro di simmetria. Per un corpo irregolare, o non omogeneo (come una mazza da baseball, più pesante da un lato), il baricentro è spostato verso la parte più pesante e si trova per via sperimentale: si appende il corpo per un punto e si traccia la verticale (con un filo a piombo); si ripete appendendolo per un altro punto; il baricentro è nell'intersezione delle due rette.
...
Consideriamo un corpo in equilibrio e spostiamolo leggermente dalla sua posizione. Possono succedere tre cose:
\begin{itemize}
\item il corpo torna nella posizione di partenza: l'equilibrio è \textbf{stabile};
\item il corpo si allontana ancora di più: l'equilibrio è \textbf{instabile};
\item il corpo resta nella nuova posizione: l'equilibrio è \textbf{indifferente}.
\end{itemize}
Il criterio si può esprimere osservando il baricentro: se lo spostamento lo \textbf{alza}, l'equilibrio è stabile (il peso tende a riportarlo giù); se lo \textbf{abbassa}, è instabile; se lo lascia \textbf{alla stessa quota}, è indifferente.

\begin{figure}[h!]
\centering
\begin{tikzpicture}[scale=0.8,>=stealth]
% stabile: vincolo sopra il baricentro (l'asta pende)
\begin{scope}
\draw[thick,gray!55] (-0.8,2.2) -- (0.8,2.2);
\foreach \x in {-0.6,-0.2,0.2,0.6}{\draw[gray!55] (\x,2.2) -- (\x-0.18,2.45);}
\fill (0,2.2) circle (1.5pt) node[above right]{\small $V$};
\draw[very thick] (0,2.2) -- (0,0.3);
\fill[blue!60!black] (0,1) circle (1.5pt) node[right]{\small $B$};
\draw[->,ocre,thick] (0,1) -- (0,-0.2) node[below,black]{$\vec{P}$};
\node at (0,-0.9) {\scriptsize stabile};
\end{scope}
% instabile: vincolo sotto il baricentro (l'asta sta ritta)
\begin{scope}[xshift=4.2cm]
\fill[gray!55] (-0.4,0.3) rectangle (0.4,0.5);
\fill (0,0.5) circle (1.5pt) node[left=2pt]{\small $V$};
\draw[very thick] (0,0.5) -- (0,2.4);
\fill[blue!60!black] (0,1.6) circle (1.5pt) node[right]{\small $B$};
\draw[->,ocre,thick] (0,1.6) -- (0,0.55) node[right,black,midway]{$\vec{P}$};
\node at (0,-0.9) {\scriptsize instabile};
\end{scope}
% indifferente: vincolo nel baricentro
\begin{scope}[xshift=8.4cm]
\draw[thick,gray!55] (-1,1.6) -- (1,1.6);
\foreach \x in {-0.8,-0.4,0,0.4,0.8}{\draw[gray!55] (\x,1.6) -- (\x-0.18,1.85);}
\draw[very thick] (0,1.6) -- (0,0.9);
\fill (0,1.6) circle (1.5pt);
\fill[blue!60!black] (0,1.6) circle (1.5pt) node[above right]{\small $V\equiv B$};
\draw[->,ocre,thick] (0,1.6) -- (0,0.4) node[below,black]{$\vec{P}$};
\node at (0,-0.9) {\scriptsize indifferente};
\end{scope}
\end{tikzpicture}
\caption{Corpo vincolato in un punto $V$: equilibrio stabile se $B$ sta sotto $V$, instabile se sta sopra, indifferente se $B$ coincide con $V$.}
\label{fig:stab}
\end{figure}
...
% caso stabile
\begin{scope}
\draw[thick] (-0.4,0) -- (2.8,0);
\begin{scope}[rotate around={14:(0.3,0)}]
\fill[gray!20] (0.3,0) rectangle (1.9,1.8);
\draw (0.3,0) rectangle (1.9,1.8);
\coordinate (Ba) at (1.1,0.9);
\end{scope}
\fill[blue!60!black] (Ba) circle (1.4pt) node[above right]{\small $B$};
\draw[->,ocre] (Ba) -- ($(Ba)+(0,-2)$);
\node[align=center] at (1.3,-2.5) {\scriptsize la verticale cade\\[-2pt]\scriptsize nella base: stabile};
\end{scope}
% caso ribaltamento
\begin{scope}[xshift=6.8cm]
\draw[thick] (-0.4,0) -- (3.2,0);
\begin{scope}[rotate around={34:(0.3,0)}]
\fill[gray!20] (0.3,0) rectangle (1.9,1.8);
\draw (0.3,0) rectangle (1.9,1.8);
\coordinate (Bb) at (1.1,0.9);
\end{scope}
\fill[blue!60!black] (Bb) circle (1.4pt) node[above right]{\small $B$};
\draw[->,ocre] (Bb) -- ($(Bb)+(0,-2.4)$);
\node[align=center] at (1.6,-2.5) {\scriptsize la verticale esce\\[-2pt]\scriptsize dalla base: si ribalta};
\end{scope}
\end{tikzpicture}
\caption{Stabilità di un corpo appoggiato: dipende da dove cade la verticale per il baricentro rispetto alla base d'appoggio.}
\label{fig:ribalta}
\end{figure}
...
\hspace*{\fill} $\left[\text{al centro; nel vuoto, al centro del foro; spostato verso il piatto}\right]$
\end{esercizio}

\begin{esercizio}
Uno sgabello con una sola gamba non può mai stare in equilibrio da solo. Perché?\\
\hspace*{\fill} $\left[\text{la base d'appoggio è quasi un punto: la verticale per } B \text{ ne esce a ogni minimo spostamento}\right]$
\end{esercizio}
...
\hspace*{\fill} $\left[\text{stabile; instabile}\right]$
\end{esercizio}
...
\hspace*{\fill} $\left[\tan\alpha = 25/90 \approx 0,28 \Rightarrow \alpha \approx 15,5^\circ\right]$
\end{esercizio}
...
\hspace*{\fill} $\left[\alpha_0 \approx 24^\circ\ ;\ \text{sì, non dipende dalla massa}\right]$
\end{esercizio}

\begin{esercizio}
Una cassa è appoggiata su un piano inclinato di $15^\circ$; il coefficiente di attrito statico è $0,40$. La cassa scivola?\\
\hspace*{\fill} $\left[\text{no: } \tan 15^\circ \approx 0,27 < 0,40\right]$
\end{esercizio}
...
\hspace*{\fill} $\left[F \approx \SI{83}{\newton}\right]$
\end{esercizio}
...
\hspace*{\fill} $\left[\SI{1,5}{\meter}\right]$
\end{esercizio}
...
\hspace*{\fill} $\left[F_m = \SI{225}{\newton}\ ;\ \text{secondo genere}\right]$
\end{esercizio}
...
\hspace*{\fill} $\left[\text{più in basso; quello con il peso sul fondo}\right]$
\end{esercizio}
...
\hspace*{\fill} $\left[\tan\alpha = 25/25 = 1 \Rightarrow \alpha = 45^\circ\right]$
\end{esercizio}

\begin{esercizio}
Spiega perché, portando uno zaino pesante sulle spalle, si tende a piegarsi in avanti.\\
\hspace*{\fill} $\left[\text{per riportare la verticale del baricentro (spostato indietro dallo zaino) dentro la base d'appoggio dei piedi}\right]$
\end{esercizio}
