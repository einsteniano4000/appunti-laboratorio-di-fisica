...
\section{Misure indirette: propagazione degli errori massimi (o strumentali)}
...
Per somme o differenze di grandezze indipendenti, l'errore assoluto totale è dato dalla **somma in quadratura** degli errori assoluti:
...
Questo approccio si applica quando gli errori sono **casuali e indipendenti**, ed è meno conservativo rispetto alla propagazione degli errori massimi, che semplicemente somma gli errori: $\Delta S = \Delta A + \Delta B$.
...
Il valore teorico dell'accelerazione, trascurando gli attriti, è:
\begin{equation}
    a_{teorica} = \frac{m_2g}{m_1 + m_2} = \frac{0,100\,\text{kg} \cdot 9,81\,\text{m/s}^2}{0,600\,\text{kg}} = 1,635\,\text{m/s}^2
\end{equation}
...
La discrepanza tra il valore teorico e quello sperimentale è significativa e può essere attribuita a:
\begin{itemize}
    \item Attrito del carrello sul piano
    \item Attrito della carrucola
    \item Massa non trascurabile della carrucola e della fune
    \item Resistenza dell'aria
\end{itemize}

\subsection{Conclusioni}
L'esperimento ha permesso di verificare qualitativamente il secondo principio della dinamica. In particolare:

\begin{itemize}
    \item I valori di accelerazione ottenuti sono consistenti tra loro entro le incertezze sperimentali
    \item La discrepanza sistematica rispetto al valore teorico è principalmente dovuta agli attriti
    \item La relazione di proporzionalità tra forza applicata e accelerazione è qualitativamente verificata
\end{itemize}

Per migliorare la precisione dell'esperimento si suggerisce di:
\begin{itemize}
    \item Utilizzare un sistema di acquisizione dati automatizzato
    \item Impiegare una rotaia a cuscino d'aria per ridurre gli attriti
    \item Utilizzare una carrucola con cuscinetti a sfera di alta qualità
    \item Aumentare la statistica delle misure
\end{itemize}
