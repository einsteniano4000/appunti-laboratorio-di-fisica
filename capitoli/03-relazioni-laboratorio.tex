...
\begin{figure}[!htbp]
    ...
    \begin{tikzpicture}[>=stealth,scale=1.1]
        ...
        \node at (1.5,1.15) {\small blocchetto};
        % pesi impilati sopra
        ...
        % --- dinamometro: tubo con profilo azzurrino e scala graduata ---
        \shadedraw[top color=blue!6,bottom color=blue!35,draw=blue!55!black,thick]
            (2.95,0.5) rectangle (5.5,1.0);
        \foreach \i in {0,...,12}{\draw[blue!55!black] (3.15+\i*0.18,1.0) -- (3.15+\i*0.18,0.87);}
        \node[right] at (5.6,0.75) {\small dinamometro};
        % --- i due gancetti intrecciati ---
        % gancio del blocchetto (apertura a destra)
        \draw[thick] (2.4,0.75) -- (2.46,0.75);
        \draw[thick] ([shift=(45:0.14)]2.58,0.75) arc (45:315:0.14);
        % gancio del dinamometro (apertura a sinistra), intrecciato col primo
        \draw[thick] (2.95,0.75) -- (2.92,0.75);
        \draw[thick] ([shift=(225:0.14)]2.78,0.75) arc (225:495:0.14);
        % forze
