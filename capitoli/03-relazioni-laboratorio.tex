...
\begin{figure}[!htbp]
    ...
    \begin{tikzpicture}[>=stealth,scale=1.1]
        % piano d'appoggio
        \fill[pattern=north east lines] (-1.2,-0.3) rectangle (7.6,0);
        \draw[thick] (-1.2,0) -- (7.6,0);
        % blocchetto
        \draw[thick,fill=brown!25] (1.0,0) rectangle (3.0,1.2);
        \node at (2.0,0.6) {\small blocchetto};
        % pesi impilati sopra
        \draw[thick,fill=gray!30] (1.3,1.2) rectangle (2.7,1.55);
        \draw[thick,fill=gray!30] (1.5,1.55) rectangle (2.5,1.85);
        \draw[->] (4.7,2.15) .. controls (3.6,2.1) .. (2.3,1.75);
        \node[right,align=left] at (4.6,2.25) {\small pesi: si aggiungono\\[-2pt] \small per aumentare $F_p$};
        % dinamometro (tira il blocchetto verso destra)
        \draw[thick] (3.0,0.55) -- (3.7,0.55);
        \draw[thick,decorate,decoration={coil,aspect=0.6,segment length=4pt,amplitude=4pt}] (3.7,0.55) -- (5.3,0.55);
        \draw[thick] (5.3,0.55) -- (6.0,0.55);
        \draw[thick,fill=white] (6.0,0.35) rectangle (6.5,0.75);
        \node[right] at (6.6,0.55) {\small dinamometro};
        % forze
        \draw[->,ocre,very thick] (1.7,0) -- (1.7,-1.1) node[below] {$\vec F_p$};
        \draw[->,red!70!black,very thick] (3.0,1.0) -- (4.15,1.0);
        \node[red!70!black,above] at (3.5,1.03) {$\vec F_{pd}$};
        \draw[->,blue!60!black,very thick] (1.0,0.28) -- (-0.3,0.28) node[left] {attrito};
    \end{tikzpicture}
