...
Il centro di massa \textbf{non} coincide con il centro geometrico se il corpo è \textbf{disomogeneo}: allora è spostato verso le zone di \textbf{maggiore densità}, dove è concentrata più massa.

\begin{testexample}[\thetcbcounter \, Una sbarretta di due materiali]
Una sbarretta lunga \SI{20}{\centi\metre}, di sezione costante, è fatta per metà di alluminio ($\rho_1 = \SI{2700}{\kilo\gram\per\metre\cubed}$) e per metà di ferro ($\rho_2 = \SI{7800}{\kilo\gram\per\metre\cubed}$). Dove si trova il centro di massa?

Le due metà hanno lo stesso volume, quindi le loro masse stanno fra loro come le densità. Il centro di massa di ciascuna metà è nel suo punto medio: a \SI{5}{\centi\metre} dall'estremo di alluminio la prima, a \SI{15}{\centi\metre} la seconda. La posizione media, pesata con le masse, è
\[ x_\text{cm} = \frac{\rho_1 \cdot 5 + \rho_2 \cdot 15}{\rho_1 + \rho_2}
   = \frac{2700 \cdot 5 + 7800 \cdot 15}{2700 + 7800} \approx \SI{12,4}{\centi\metre}. \]
Non è al centro geometrico (\SI{10}{\centi\metre}), ma è spostato di circa \SI{2,4}{\centi\metre} verso la metà di ferro, più densa.
\end{testexample}
