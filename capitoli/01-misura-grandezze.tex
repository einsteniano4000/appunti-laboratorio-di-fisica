...
\begin{figure}[!htbp]
    ...
    \begin{tikzpicture}[font=\footnotesize,>=stealth]
        ...
        \begin{scope}[x={(im.south east)},y={(im.north west)}]
            ...
            % punti sulle parti
            \foreach \p in {(0.105,0.955),(0.205,0.905),(0.115,0.11),(0.215,0.30),
            ...
            \draw[guida] (0.105,0.955) -- (0.135,1.05);
            \draw[guida] (0.205,0.905) -- (0.155,1.05);
            \node[lab,anchor=south] at (0.145,1.05) {becchi per misure interne};
