...
\begin{figure}[!htbp]
    ...
    \begin{tikzpicture}[font=\footnotesize,>=stealth]
        ...
        \begin{scope}[x={(im.south east)},y={(im.north west)}]
            \tikzset{lab/.style={fill=white,fill opacity=0.9,text opacity=1,
                                 inner sep=1.5pt,rounded corners=1pt},
                     guida/.style={line width=0.9pt,black!75}}
            % punti sulle parti
            \foreach \p in {(0.062,0.965),(0.104,0.975),(0.09,0.20),(0.205,0.26),
                            (0.55,0.585),(0.365,0.79),(0.33,0.545),(0.405,0.42)}
                \fill[black!80] \p circle (1pt);
            % --- etichette sopra ---
            ...
            % --- etichette sotto ---
            \draw[guida] (0.09,0.20) .. controls (0.10,0.05) .. (0.115,-0.06);
            \draw[guida] (0.205,0.26) .. controls (0.19,0.05) .. (0.165,-0.06);
